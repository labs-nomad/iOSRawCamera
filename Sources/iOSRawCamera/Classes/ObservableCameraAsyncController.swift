//
//  ObservableCameraAsyncController.swift
//  
//
...
public struct ObservableCameraAsyncController {
    ...
    public func startAsync(cameraController controller: ObservableCameraController, callback: EmptyCallback? = nil, returnQueue: DispatchQueue = DispatchQueue.main) {
        self.serialDispatchQueue.async {
    ...
    ///   - callback: The callback that tells you when the `CameraController` was sucessfully started
    ///   - returnQueue: The `DispatchQueue` that you want the call to return on. Defaults to the man UI Queue
    public func stopAsync(cameraController controller: ObservableCameraController, callback: EmptyCallback? = nil, returnQueue: DispatchQueue = DispatchQueue.main) {
        self.serialDispatchQueue.async {
    ...
    ///   - callback: The callback that tells you when the `CameraController` was sucessfully started
    ///   - returnQueue: The `DispatchQueue` that you want the call to return on. Defaults to the man UI Queue
    public func resetAsync(cameraController controller: ObservableCameraController, callback: EmptyCallback? = nil, returnQueue: DispatchQueue = DispatchQueue.main) {
        self.serialDispatchQueue.async {
    ...
    ///   - callback: The callback that tells you when the `CameraController` was sucessfully started
    ///   - returnQueue: The `DispatchQueue` that you want the call to return on. Defaults to the man UI Queue
    public func toggleAsync(cameraController controller: ObservableCameraController, callback: EmptyCallback? = nil, returnQueue: DispatchQueue = DispatchQueue.main) {
        self.serialDispatchQueue.async {
    ...
    ///   - callback: The callback that tells you when the `CameraController` was sucessfully started
    ///   - returnQueue: The `DispatchQueue` that you want the call to return on. Defaults to the man UI Queue
    public func swapCamerasAsync(cameraController controller: ObservableCameraController, callback: ErrorCallback? = nil, returnQueue: DispatchQueue = DispatchQueue.main) {
        self.serialDispatchQueue.async {
            do {
